...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self._json_name = "mast3r_camerapose.json"
        self._ply_name = "input_view0.ply"
        self._trust_num = 0
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.opacity_threshold_coarse = 0.0025
        self.opacity_threshold_fine_init = 0.0025
        self.opacity_threshold_fine_after = 0.0025

        self.depth_l1_weight_init = 5e-4
        self.depth_l1_weight_final = 1e-6

        self.batch_size=1
        self.add_point=False

        self.random_background = True
        # self.pose_init_iterations = int(0.5 * self.coarse_iterations)  #1500
        # self.pose_iterations = self.coarse_iterations  #3000
